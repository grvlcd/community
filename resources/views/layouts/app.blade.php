            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="mr-auto navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <div class="px-2 dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <div class="mb-2">
                                    <a class="mb-2 text-center text-white rounded dropdown-item bg-success" href="{{ route('communities.create') }}">
                    ...
                    <ul class="ml-auto navbar-nav">
                        ...
                        @else
                        <li class="nav-item dropdown">
                            <div id="navbarDropdown" class="chip nav-link" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="border rounded-circle border-secondary" src="{{ asset('images/' . Auth::user()->image->path) }}" alt="{{ Auth::user()->name }}" width="24" height="24">
